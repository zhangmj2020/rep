...
int cks_mmc_read(int mmc_cont, unsigned int src, unsigned char *dst, int size);
int cks_mmc_write(int mmc_cont, unsigned int *src, unsigned long dst, int size);
int cks_mmc_init(void);
