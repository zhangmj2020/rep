...
#define SDIO_REG_HSFR0 (*(volatile unsigned int  *)  (CKS_SDMMC_BASE + 0x0000))
/// initialization setting register
#define SDIO_REG_HSFR1 (*(volatile unsigned int  *)  (CKS_SDMMC_BASE + 0x0004))
/// DMA setting register
#define SDIO_REG_HSFR2 (*(volatile unsigned int  *)  (CKS_SDMMC_BASE + 0x0008))
