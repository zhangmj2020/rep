...
#ifndef CONFIG_$(SPL_TPL_)DM_SERIAL

static volatile unsigned char *const port[] = CONFIG_PL01x_PORTS;
enum pl01x_type pl01x_type __attribute__ ((section(".data"))) = TYPE_PL011 ;
struct pl01x_regs *base_regs __attribute__ ((section(".data"))) = CONFIG_PL01x_PORTS ;
